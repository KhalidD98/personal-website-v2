      ...
      <div className="py-16 px-8">
        ...
        <div className="grid grid-cols-2 gap-6 auto-rows-auto">
          ...
          <div className="col-span-2">
            <div className="bg-white rounded-3xl shadow-lg border-4 border-blue-200 hover:shadow-xl transition-all duration-300 h-full">
              <div className="p-10">
                ...
                <p className="text-gray-600 mb-5 leading-relaxed text-sm">Software platform that simplifies marketing, registration, payment processing, and operations for early education.</p>
          ...
          <div className="col-span-1">
            <div className="bg-white rounded-3xl shadow-lg border-4 border-blue-200 hover:shadow-xl transition-all duration-300 h-full">
              <div className="p-8">
                ...
                <p className="text-gray-600 mb-4 leading-relaxed text-sm">Web application designed to help banks organize and manage community involvement efforts including events, donations, loans, investments, and more.</p>
                <ul className="space-y-2 text-gray-700 leading-relaxed text-xs">
          ...
          <div className="col-span-1">
            <div className="bg-white rounded-3xl shadow-lg border-4 border-blue-200 hover:shadow-xl transition-all duration-300 h-full">
              <div className="p-8">
                ...
                <p className="text-gray-600 mb-4 leading-relaxed text-sm">Web application designed to connect users with researchers, increase access to publications, and act as a space for teams to work on research-related projects</p>
                <ul className="space-y-2 text-gray-700 leading-relaxed text-xs">
          ...
          <div className="col-span-1">
            <div className="bg-white rounded-3xl shadow-lg border-4 border-green-200 hover:shadow-xl transition-all duration-300 h-full">
              <div className="p-8">
                <div className="flex items-center justify-between mb-4">
                  <div>
          ...
          <div className="col-span-1">
            <div className="bg-white rounded-3xl shadow-lg border-4 border-green-200 hover:shadow-xl transition-all duration-300 h-full">
              <div className="p-8">
                ...
                <p className="text-gray-700 mb-3 leading-relaxed text-sm"><span className="font-bold">Created a custom Minecraft Server that controls multiple streamers' donations and redemptions separately</span> through the <span className="font-bold">Twitch Pub/Sub</span> allowing viewers to spawn mobs (monsters) on each streamer individually.</p>
                <p className="text-gray-700 leading-relaxed text-xs">Implemented <span className="font-bold">Firebase authentication and Twitch API connections</span> on a web app created with <span className="font-bold">React.js</span> to allow the controlling of settings for donation pricing for each individual streamer</p>
              </div>
            </div>
          </div>
